...
def make_new_dset(
    ...
    dtype: onp.AnyDType | Datatype | None = None,
    data: onp.AnyArray | Empty | None = None,
...
class AstypeWrapper:
    def __init__(self, dset: Dataset, dtype: onp.AnyDType) -> None: ...
    def __getitem__(self, args: object) -> onp.AnyArray | Empty | FieldsWrapper: ...
    def __len__(self) -> int: ...
    def __array__(self, dtype: onp.AnyDType | None = None, copy: bool = True) -> onp.AnyArray: ...

class AsStrWrapper:
    def __init__(self, dset: Dataset, encoding: str | None, errors: str = "strict") -> None: ...
    def __getitem__(self, args: object) -> str | onp.AnyStrArray: ...
    def __len__(self) -> int: ...
    def __array__(self, dtype: onp.AnyDType | None = None, copy: bool = True) -> onp.AnyArray: ...
...
class Dataset(HLObject):
    def astype(self, dtype: onp.AnyDType) -> AstypeWrapper: ...
    ...
    def __getitem__(self, args: object, new_dtype: onp.AnyDType | None = None) -> onp.AnyArray | FieldsWrapper | Empty: ...
    def __setitem__(self, args: object, val: object) -> None: ...
    def read_direct(self, dest: onp.AnyArray, source_sel: object | None = None, dest_sel: object | None = None) -> None: ...
    def write_direct(self, source: onp.AnyArray, source_sel: object | None = None, dest_sel: object | None = None) -> None: ...
    def __array__(self, dtype: onp.AnyDType | None = None, copy: bool = True) -> onp.AnyArray: ...
