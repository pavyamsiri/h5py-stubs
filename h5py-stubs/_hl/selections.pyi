...
__all__ = ["FancySelection", "PointSelection", "Selection", "SimpleSelection", "guess_shape", "select"]

@overload
def select(shape: tuple[int, ...], args: Selection | tuple[Selection], dataset: Dataset | None = None) -> Selection: ...
@overload
def select(shape: tuple[int, ...], args: onp.AnyBoolArray, dataset: Dataset | None = None) -> PointSelection: ...
@overload
...
class PointSelection(Selection):
    def __init__(self, shape: tuple[int, ...], spaceid: SpaceID | None = None, points: onp.CanArray | None = None) -> None: ...
    @classmethod
    def from_mask(cls, mask: onp.AnyBoolArray, spaceid: SpaceID | None = None) -> Self: ...
    def append(self, points: onp.CanArray) -> None: ...
    def prepend(self, points: onp.CanArray) -> None: ...
    def set(self, points: onp.CanArray) -> None: ...
