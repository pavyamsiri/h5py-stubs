...
# Case 1: vlen = dtype
@overload
def check_dtype(*, vlen: onp.DType) -> onp.DType | None: ...

# Case 2: enum = dtype
@overload
def check_dtype(*, enum: onp.DType) -> dict[str, int] | None: ...

# Case 3: ref = dtype
@overload
def check_dtype(*, ref: onp.DType) -> type[Reference | RegionReference] | None: ...
...
@overload
def special_dtype(*, vlen: type[str] | onp.DType) -> ObjectDType: ...
...
@overload
def string_dtype(encoding: _Encoding, length: int) -> BytesDType: ...
...
def check_enum_dtype(dt: onp.DType) -> dict[str, int] | None: ...
def check_opaque_dtype(dt: onp.DType) -> bool: ...
def check_ref_dtype(dt: onp.DType) -> type[Reference | RegionReference] | None: ...
def check_string_dtype(dt: onp.DType) -> string_info: ...
def check_vlen_dtype(dt: onp.DType) -> onp.DType | None: ...
...
def py_create(dtype_in: onp.DType | str, logical: bool = False, aligned: bool = False) -> TypeID: ...
