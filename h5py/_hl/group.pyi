...
class Group(HLObject, MutableMappingHDF5):
    ...
    if vds_support:
        ...
        @contextmanager
        def build_virtual_dataset(self, name, shape, dtype, maxshape=..., fillvalue=...): # -> Generator[VirtualLayout, Any, None]:
    ...
    def get(self, name, default=..., getclass=..., getlink=...): # -> Group | Dataset | Datatype | type[Group] | type[Dataset] | type[Datatype] | type[SoftLink] | SoftLink | type[ExternalLink] | ExternalLink | type[HardLink] | HardLink | None:
    ...
    def copy(self, source, dest, name=..., shallow=..., expand_soft=..., expand_external=..., expand_refs=..., without_attrs=...): # -> None:
